// IncidenceSubsetHandler.h: interface for the CIncidenceSubsetHandler class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_INCIDENCESUBSETHANDLER_H__8A2E7E27_AAFA_42C0_AFEA_A3EC8882472B__INCLUDED_)
#define AFX_INCIDENCESUBSETHANDLER_H__8A2E7E27_AAFA_42C0_AFEA_A3EC8882472B__INCLUDED_
...
//	void updateEvlAmp(CEvl &cEvl, int indexI, int indexF);
	...
	int getEvlID();
	int getISCID();
	CIncidenceSubsetHandler();
	virtual ~CIncidenceSubsetHandler();
	void buildSubsets();
...
#endif // !defined(AFX_INCIDENCESUBSETHANDLER_H__8A2E7E27_AAFA_42C0_AFEA_A3EC8882472B__INCLUDED_)
